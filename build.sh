...
podman run --privileged -v /var/lib/ca-certificates:/var/lib/ca-certificates -v /var/lib/Kiwi/repo:/var/lib/Kiwi/repo -v $TARGET_DIR/kiwi.yml:/etc/kiwi.yml  -v $TARGET_DIR:/image:Z registry.suse.com/bci/kiwi:10.1.10 kiwi-ng --debug --profile aarch64-self_install-gpu-encrypted system build --allow-existing-root --description /image --target-dir /image/image \
--ignore-repos-used-for-build --add-repo file:/var/lib/Kiwi/repo,rpm-dir,common_repo,90,false,false --add-bootstrap-package findutils --add-bootstrap-package rhn-org-trusted-ssl-cert-osimage \
--add-repo https://susemanager.weiss.ddnss.de/pub/isos/slmicro60a64 \
--add-repo https://susemanager.weiss.ddnss.de/ks/dist/slmicro60a64-test,repo-md,SL-Micro-6.0-Test-Pool \
--add-repo https://susemanager.weiss.ddnss.de/ks/dist/child/staging-slmicro60a64-test-sndirsch-sidecar-slmicro60-a64/slmicro60a64-test,repo-md,sndirsch-sidecar-slmicro60-a64 \
--add-repo https://susemanager.weiss.ddnss.de/ks/dist/child/staging-slmicro60a64-test-libnvidia-container-a64/slmicro60a64-test,repo-md,libnvidia-container-a64 \
